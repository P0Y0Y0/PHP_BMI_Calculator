    ...
    <div class="container" style="width:25%">
        ...
        <div class="row">
            ...
            <div class="justify-content-center text-center">
                <button onClick="location.href = 'index.php';" class="btn btn-primary mt-5">Calculate Again</button>
                <button onClick="location.href = 'history.php';" class="btn btn-primary mt-5">View History</button>
            </div>
        </div>
    </div>
